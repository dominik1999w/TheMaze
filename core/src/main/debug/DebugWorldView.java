...
import renderable.SimpleView;
import types.TextureType;
import world.World;

public class DebugWorldView implements Renderable {

    private final MapView mapView;
    private final List<SimpleView<? extends WorldEntity>> views = new ArrayList<>();
    private final OrthographicCamera camera;

    public DebugWorldView(World<?> world, Map map, OrthographicCamera camera, Player localPlayer, AssetManager assetManager) {
